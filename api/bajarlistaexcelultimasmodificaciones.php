...
$sheet->setCellValue('A' . $rowCount, "PRODUCTO");
    ...
    $sheet->setCellValue('G' . $rowCount, "ULTIMA MODIFICACION");
    ...
    foreach ($myArrayProductos as $j => $prod) {
            ...
            $sheet->setCellValueExplicit('G' . $rowCount, $prod['fechaUltimaModificacion'],PHPExcel_Cell_DataType::TYPE_STRING);
...
header('Content-Disposition: attachment;filename="Lista Kosher - Ultimas modificaciones.xlsx"');
