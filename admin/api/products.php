        ...
        if (Autho::verifyJWT($token)) {
            ...
            switch($requestMethod) {
                ...
                case 'POST':
                    ...
                    $query = sprintf("INSERT INTO `producto` (`id`, `marca`, `imagen`, `rubroId`, `nivelId`, `lecheparveId`, `descripcion`, `publicar`, `sintacc`, `barcode` ) VALUES( \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\", \"%s\") 
                    ON DUPLICATE KEY UPDATE  `marca`= \"%s\", `imagen`= \"%s\", `rubroId`= \"%s\", `nivelId`= \"%s\", `lecheparveId`= \"%s\", `descripcion` = \"%s\", `publicar` = \"%s\", `sintacc` = \"%s\", `barcode` = \"%s\"",
                    
                    $id, $marca, $imagen, $rubroId, $nivelId, $lecheparveId, $descripcion, $publicar, $sintacc, $barcode, $marca, $imagen, $rubroId, $nivelId, $lecheparveId, $descripcion, $publicar, $sintacc, $barcode);
